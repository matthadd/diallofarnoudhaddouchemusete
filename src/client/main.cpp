...
int main(int argc, char *argv[])
{
    ...
    {
        state::State state;
        state::UnitInstance* AIunit = new UnitInstance(DWARF, 1, 1, 1, 1, 0);
        state::UnitInstance* OtherUnit = new UnitInstance(BAT, Player_ID, 1, 0, 1, 1, 0);
    ...
    else 
    {
        ...
        vector<int> pos = warrior1->getPosition();
